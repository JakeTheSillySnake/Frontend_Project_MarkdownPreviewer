...
class Previewer extends React.Component {
  ...
  render() {
    return (
      <div>
        <h2 className="header"><i className="fa-brands fa-markdown"></i> Editor <button onClick={this.handleClick}>Clear</button></h2>
        <textarea id="editor" onChange={this.handleChange} value={this.state.input}>
        </textarea>
        <h2 className="header"><i className="fa-brands fa-markdown"></i> Previewer</h2>
